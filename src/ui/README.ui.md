...
The UI is server-side rendered using hono/jsx.
...
Follow examples in Layout.tsx file and `ui.tsx` files.

You can also use the Hono `html` and `raw` helpers. 
...
<table class="header">
  ...
  <tr>
    <th>Updated</th>
    <td class="width-min"><time style="white-space: pre;">2025-08-20</time></td>
  </tr>
  <tr>
...
<figure>
<img src="demo/castle.jpg"
alt="A room in an old French castle (2024)" />
